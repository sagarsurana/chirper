import '../lib/raf-shim'; //fix raf warning
...
describe('Source code is valid', () => {
  test('JavaScript lints without errors', async () => {
    const sources = ['index.js', 'App.js', 'components/chirper/ChirpBox.js', 'components/chirper/ChirpList.js'].map((src) => __dirname + '/js/' + src);
